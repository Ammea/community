...
@Controller
public class LonginController implements CommunityConstant {
    ...
    public String getRegisterPage(){  //这个string表明返回的视图view层的名字
        return "/site/register";
    }

    @RequestMapping(path="/login",method = RequestMethod.GET)
    public String getLoginPage(){  //这个string表明返回的视图view层的名字
        return "/site/login";
    }
    ...
    //在此之前更新了userservice，如果待会儿报错可以去那里找问题
    ...
    public String login(String username, String password, String code, boolean rememberme,
        ...
        // 检查账号,密码
        // 从浏览器得到数据 开始调用服务层验证账号密码是否有效 验证的时候服务层会调用dao层
