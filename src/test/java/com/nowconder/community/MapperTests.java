...
import com.nowconder.community.dao.LoginTicketMapper;
...
//        System.out.println(user);
//
//        user = userMapper.selectByEmail("nowconder101@sina.com");
//        System.out.println(user);
    }
    ...
    public void myTest(){
        ...
        System.out.println(new Date(System.currentTimeMillis()+8640000));
        System.out.println(new Date(System.currentTimeMillis()+8640000*100));
        System.out.println("=========");
    }
}
